...
class GeneratorBodyDefNode(DefNode):
    ...
    def generate_function_definitions(self, env, code):
        ...
        if self.is_inlined and self.inlined_comprehension_type is not None:
            ...
            elif target_type.is_set:
                comp_init = 'PySet_New(NULL)'
            elif target_type.is_dict:
...
class DelStatNode(StatNode):
    ...
    def analyse_expressions(self, env):
        for i, arg in enumerate(self.args):
            ...
            elif arg.is_subscript and arg.base.type.is_bytearray:
                pass  # del ba[i]
            else:
    ...
    def generate_execution_code(self, code):
        ...
        for arg in self.args:
            if (arg.type.is_pyobject or
                    ...
                    arg.is_subscript and arg.base.type.is_bytearray):
    ...
    def analyse_expressions(self, env):
        ...
        if self.exc_value:
            ...
            if self.wrap_tuple_value:
                if exc_value.type.is_tuple or not exc_value.type.is_builtin_type:
